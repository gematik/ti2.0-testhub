...
class VsdmServiceITTest {
  ...
  void setUp() throws URISyntaxException {
    ...
    final Path systemResource = Path.of(ClassLoader.getSystemResource("vsdmservice/").toURI());
    TestDataManager.initializeWithoutClasspath(Set.of(systemResource));

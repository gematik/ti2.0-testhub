...
@Configuration
@EnableWebSocket
public class PoppWsConfig implements WebSocketConfigurer {

  private final SmartcardController smartcardController;

  public PoppWsConfig(final SmartcardController smartcardController) {
    this.smartcardController = smartcardController;
  }

  @Override
  public void registerWebSocketHandlers(final WebSocketHandlerRegistry registry) {
    smartcardController.addHandlers(registry);
  }
}

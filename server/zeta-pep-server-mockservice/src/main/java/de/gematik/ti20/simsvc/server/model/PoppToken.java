...
public class PoppToken {
  ...
  public static class TokenClaims {
    ...
    private String proofMethod = "ehc-provider-user-x509";
    private long patientProofTime = System.currentTimeMillis() / 1000;
    ...
    public TokenClaims(
        ...
        long iat,
        String proofMethod,
        long patientProofTime,
        String patientId,
        String insurerId,
        String actorId,
        String actorProfessionOid) {
    ...
    public TokenClaims(
        String patientId, String insurerId, String actorId, String actorProfessionOid) {
      this.patientId = patientId;
      this.insurerId = insurerId;
      this.actorId = actorId;
      this.actorProfessionOid = actorProfessionOid;
  ...
  private static void validateCertificateChain(List<X509Certificate> certs, KeyStore keyStore)
    ...
    log.debug("Certs in the chain: {}", certs);

...
public class RequestPoppTokenFromCache implements Task {

  public static RequestPoppTokenFromCache fromCache() {
    return instrumented(RequestPoppTokenFromCache.class);
  }

...
class VsdmServerIT {
  ...
  void testCallSuccessful() throws Exception {
    ...
    assertEquals("given-name-X111111111", patient.getName().get(0).getGiven().get(0).getValue());

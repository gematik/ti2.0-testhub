...
public enum CommType {
  ...
  CommType(final String value, final String readerType, final String commType) {
    this.value = value;
    this.readerType = readerType;
    this.commType = commType;
  }

  private static final Map<String, CommType> MAPPING =
      Stream.of(values())
          .collect(
  ...
  public static CommType from(final String readerType, final String commType) {

...
Funktionalität: Betriebsdatenerfassung VSDM 2.0
  ...
  @TCID:UC_VSDM2_RVSD_ERROR_BDE_CODE_79010
  ...
  @PRIO:2
  @DESCRIPTION
  Szenariogrundriss: BDE Fehlercode 79010 - IK Fehler
  ...
  Fehlerfall könnte z.B. ein falsch konfiguriertes Routing zum Fachdienst VSDM 2.0 sein.
    ...
    Beispiele:
      ...
      | "smcbCardImage.xml" | 1         | "egkCardImage.xml" | 2        | 400       | "VSDSERVICE_INVALID_IK" |

...
/** Request DTO for transmitting APDU commands to a card. */
public class TransmitRequestDto {
  ...
  /**
   * Constructor with APDU command.
   *
   * @param command The APDU command as hex string
   */
   ...
   *
   * @return The APDU command as hex string
   */

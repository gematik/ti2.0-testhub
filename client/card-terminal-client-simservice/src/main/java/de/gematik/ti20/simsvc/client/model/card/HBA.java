...
/**
 * Represents an HBA (Health Professional Card / Heilberufsausweis) card's data structure. This is
 * an alias for HPC for compatibility with different naming conventions.
 */
...
public class HBA {
  ...
  /** Container class for applications within an HBA. */

...
class TransmitRequestDtoTest {
  ...
  void testDefaultConstructorAndSetter() {
    ...
    dto.setCommand("00A40400");
    assertEquals("00A40400", dto.getCommand());
  }

  @Test
  void testConstructorWithCommand() {
    TransmitRequestDto dto = new TransmitRequestDto("80CA9F7F00");
    assertEquals("80CA9F7F00", dto.getCommand());
  }
}

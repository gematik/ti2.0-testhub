...
@Slf4j
public class PoppTokenFromCacheStrategy {

  private final PoppTokenRepository poppTokenRepository;

  public PoppTokenFromCacheStrategy(final PoppTokenRepository poppTokenRepository) {
  ...
  public Optional<PoppToken> get(
    ...
    if (poppTokenFromRepository != null) {
      ...
      return Optional.of(poppTokenFromRepository).map(PoppToken::new);
    }
